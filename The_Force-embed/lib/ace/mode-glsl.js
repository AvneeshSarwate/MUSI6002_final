...
var glslHighlightRules = function() {
    ...
    var glFunctions = (
        "dFdx|dFdy|fwidth|sampler2D|" +
        "samplerCube|texture2D|texture2DProj|texture2DLod|" +
    ...
    var headerFunctions = (
        "rand|box|circle|rotate|snoise|noise|fractal|hsv2rgb|turbulence|voronoi|sexy|nyanFrame|uv|uvN|swirl|sinN|cosN|pattern"
        );

    var uniforms = (
        "resolution|time|channelTime|mouse|date|channelResolution|bands|" +
        "backbuffer|channel0|channel1|channel2|channel3|"
        );

    var keywordMapper = this.createKeywordMapper({
        "string.other" : colorsPlus,
