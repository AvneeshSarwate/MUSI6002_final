...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.0, 26.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "7 and .8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 404.5, 43.0, 22.0 ],
					"style" : "",
					"text" : "/onset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 472.5, 147.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 287.0, 441.5, 113.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 491.0, 62.0, 156.0, 74.0 ],
					"style" : "",
					"text" : "taken from second answer here https://cycling74.com/forums/fastest-onset-detection-native-or-external"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 435.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 59.0, 31.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 254.5, 228.0, 130.0, 130.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 461.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 168.0, 390.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 168.0, 357.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 377.0, 86.0, 54.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 58.0, 98.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 275.0, 46.0, 56.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 317.0, 137.0, 32.5, 20.0 ],
					"style" : "",
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 275.0, 110.0, 63.0, 20.0 ],
					"style" : "",
					"text" : "bondo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 319.0, 85.0, 56.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 163.0, 61.0, 20.0 ],
					"style" : "",
					"text" : "pak 0.5 2.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.5, 389.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "send~ trig"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 112.0, 228.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 72.5, 268.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "thresh~ 0.5 2.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 72.5, 327.0, 38.0, 22.0 ],
					"style" : "",
					"text" : ">~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 72.5, 298.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "change~"
				}
...
,
					"patching_rect" : [ 73.5, 151.0, 178.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 284.5, 204.0, 121.5, 204.0 ],
					"source" : [ "obj-182", 0 ]
				}
